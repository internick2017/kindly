<?php
/**
 * Title: Team — Our people
 * Slug: kindly/team
 * Categories: kindly
 * Description: A grid of team or leadership members.
 */
?>
...
<h3 class="wp-block-heading has-large-font-size"><?php esc_html_e( 'Sarah Lee', 'kindly' ); ?></h3>
<!-- /wp:heading -->

<!-- wp:paragraph {"textColor":"primary","fontSize":"small"} -->
<p class="has-primary-color has-text-color has-small-font-size"><?php esc_html_e( 'Director', 'kindly' ); ?></p>
<!-- /wp:paragraph --></div>
<!-- /wp:column -->
...
<!-- wp:heading {"level":3,"fontSize":"large"} -->
<h3 class="wp-block-heading has-large-font-size"><?php esc_html_e( 'James Carter', 'kindly' ); ?></h3>
<!-- /wp:heading -->

<!-- wp:paragraph {"textColor":"primary","fontSize":"small"} -->
<p class="has-primary-color has-text-color has-small-font-size"><?php esc_html_e( 'Outreach lead', 'kindly' ); ?></p>
<!-- /wp:paragraph --></div>
<!-- /wp:column -->
...
<!-- wp:heading {"level":3,"fontSize":"large"} -->
<h3 class="wp-block-heading has-large-font-size"><?php esc_html_e( 'Aisha Khan', 'kindly' ); ?></h3>
<!-- /wp:heading -->

<!-- wp:paragraph {"textColor":"primary","fontSize":"small"} -->
<p class="has-primary-color has-text-color has-small-font-size"><?php esc_html_e( 'Volunteer coordinator', 'kindly' ); ?></p>
<!-- /wp:paragraph --></div>
<!-- /wp:column --></div>
<!-- /wp:columns --></div>
<!-- /wp:group -->
