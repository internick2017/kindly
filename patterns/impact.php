 ...
 * Slug: kindly/impact
 * Categories: kindly
 * Description: A row of impact statistics.
 */
?>
...
<h2 class="wp-block-heading has-text-align-center"><?php esc_html_e( 'Our impact this year', 'kindly' ); ?></h2>
<!-- /wp:heading -->
...
<p class="has-text-align-center"><?php esc_html_e( 'Meals served', 'kindly' ); ?></p>
<!-- /wp:paragraph --></div>
<!-- /wp:column -->
...
<!-- wp:paragraph {"align":"center"} -->
<p class="has-text-align-center"><?php esc_html_e( 'Active volunteers', 'kindly' ); ?></p>
<!-- /wp:paragraph --></div>
<!-- /wp:column -->
...
<!-- wp:paragraph {"align":"center"} -->
<p class="has-text-align-center"><?php esc_html_e( 'Families supported', 'kindly' ); ?></p>
<!-- /wp:paragraph --></div>
<!-- /wp:column --></div>
<!-- /wp:columns --></div>
<!-- /wp:group -->
